...
# | --> Cfr. Super Experiment 2, but without specialisation and peer-group-awareness 	  |
# |			i.e.:																		  |
# | 			dense intra-peer-group-layer 				    					      |
# |				random portfolio-normalized groups at input								  |
# +---------------------------------------------------------------------------------------+
super_experiment_name = "super_experiment_8"
...
expert_name = "no_second_layer_no_groups"
pre_training = True
window = 1
reward_type="p&l"
