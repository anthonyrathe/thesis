...
# |                                  Super Experiment 6                                   |
# +---------------------------------------------------------------------------------------+
# |                		         Peer-group-awareness only             		              |
# +---------------------------------------------------------------------------------------+
# | Super experiment testing combinations of:											  |
# |		- StackedEnv, StackedEnvDiff, StackedEnvBinary									  |
# |		- 0.0, 0.0002, 0.005 transaction costs											  |
# | --> Cfr. Super Experiment 2, but without specialisation, i.e.:						  |
# | 			intra-peer-group-layer without shared weights   					      |
# +---------------------------------------------------------------------------------------+
super_experiment_name = "super_experiment_6"
