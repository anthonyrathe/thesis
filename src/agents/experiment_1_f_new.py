...
# |                                   Experiment 1 f                                      |
# +---------------------------------------------------------------------------------------+
# | Cfr. experiment 1 b, but with concurrent training, second layer features and		  |
# | transaction costs.																	  |
# +---------------------------------------------------------------------------------------+
